...
class ModifiedStableDiffusionPipeline_Rep(StableDiffusionPipeline):
    def __init__(self,
        vae,
        text_encoder,
        tokenizer,
        ...
        super(ModifiedStableDiffusionPipeline_Rep, self).__init__(
                vae,
                text_encoder,
                tokenizer,
                unet,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if repellency_processor is not None:
                    ...
                    x_0_hat_repellenced = repellency_processor.conditioning(x_0_hat)['x_0_hat']
