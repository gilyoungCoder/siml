#!/bin/bash
# ============================================================================
# VLM Evaluation for Best Configs - HIGH TOXICITY ONLY (skip + skip_ca)
# ============================================================================
...
echo -e "${GREEN}============================================================${NC}"
echo -e "${GREEN}VLM Evaluation - Best Configs (HIGH_TOX) [skip + skip_ca]${NC}"
...
eval_concept() {
    ...
    echo -e "\n${GREEN}Evaluating: ${concept^^} (high_tox)${NC}"
...
echo -e "\n${GREEN}HIGH_TOX Evaluation Complete!${NC}"
