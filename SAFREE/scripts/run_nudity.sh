export CUDA_VISIBLE_DEVICES=4          # 사용할 GPU
...
for ATTACK_TYPE in cnb # ring-a-bell unlearndiff mma-diffusion i2p
do
    thr=0.6
    ...
    elif [ "$ATTACK_TYPE" = "cnb" ]; then
        attack_data="/mnt/home/yhgil99/guided2-safe-diffusion/prompts/country_naked_body.txt"
    else    
