...
OUTPUT_DIR="/mnt/home/yhgil99/unlearning/10_classification/Continual/3classifier/"+$F_SCALE                # 출력 디렉토리 경로
PROMPT_FILE="/mnt/home/yhgil99/guided2-safe-diffusion/prompts/null.txt"  # 프롬프트 파일 경로
...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/three_classificaiton_new/work_dirs/nudity_three_class_Imagenet_Plus12600/checkpoint/step_6100/classifier.pth"  # 자유 모델 체크포인트
...
CONFIG_PATH="/mnt/home/yhgil99/unlearning/three_classificaiton/configs/models/time_dependent_discriminator.yaml"
