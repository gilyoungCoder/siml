...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/three_classificaiton_new/work_dirs/nudity_three_class_Imagenet_Filtered/checkpoint/step_21800/classifier.pth"  # 자유 모델 체크포인트
PHASE="all"
...
for F_SCALE in $(seq 5 5 50); do
    ...
    OUTPUT_DIR="Continual/CountryBody2PeopleAll/${PHASE}DDIM/${F_SCALE}"
    mkdir -p "$OUTPUT_DIR"
