...
PARTIAL_NUDITY_DIR=$DATA_ROOT/Partial_Nudity
...
USE_WANDB="--use_wandb --report_to wandb --wandb_project five_class_project --wandb_run_name five_class_run"

# (7) 학습 실행
nohup python train5class.py \
