...
class ElevenClassDataset(Dataset):
    """
    11-class dataset:
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train an 11-class classifier of nudity/person levels with DDPM noise injection"
    )
    ...
    parser.add_argument("--output_dir", type=str, default="eleven_class_output")
    ...
    parser.add_argument("--wandb_project", type=str, default="eleven_class_project")
...
def main():
    ...
    # Dataset & Dataloader
    full_dataset = ElevenClassDataset(
    ...
    while global_step < max_steps:
        for batch in train_loader:
            ...
            logits  = classifier(noisy_latents, norm_ts)  # [B,11]
