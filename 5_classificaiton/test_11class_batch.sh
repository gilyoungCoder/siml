...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/5_classificaiton/work_dirs/five_class_output/checkpoint/step_20100/classifier.pth"
CONFIG_PATH="/mnt/home/yhgil99/unlearning/5_classificaiton/configs/models/time_dependent_discriminator.yaml"
G_START=1
GUIDING_CLASS=1

# (2) F_SCALE 값 리스트
for F_SCALE in 5 10 15; do
    # (3) 출력 디렉토리
    OUTPUT_DIR="Continual/CountryNudeBodyMulti/${F_SCALE}"
    mkdir -p "$OUTPUT_DIR"
