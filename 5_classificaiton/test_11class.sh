...
OUTPUT_DIR="Continual/4classifier_stepIndexModified1/"+$F_SCALE                # 출력 디렉토리 경로
...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/5_classificaiton/work_dirs/five_class_output/checkpoint/step_20100/classifier.pth"  # 자유 모델 체크포인트
...
CONFIG_PATH="/mnt/home/yhgil99/unlearning/5_classificaiton/configs/models/time_dependent_discriminator.yaml"
