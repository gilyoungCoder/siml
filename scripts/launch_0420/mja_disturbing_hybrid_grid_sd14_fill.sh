#!/bin/bash
# MJA-disturbing SD1.4 hybrid ours grid FILL-IN (4 configs not in retune).
# Usage: bash mja_disturbing_hybrid_grid_sd14_fill.sh <gpu_id> <slot_idx> <n_slots>
set -uo pipefail
GPU=$1
SLOT=$2
NSLOTS=$3
...
# 4 configs missing (retune already did ss10/imgthr0.4, ss15/imgthr0.4, ss15/imgthr0.5, ss20/imgthr0.3, ss20/imgthr0.4)
JOBS=(
  "10|0.1|0.3"
  "10|0.1|0.5"
  "15|0.1|0.3"
...
for ((i=SLOT; i<N; i+=NSLOTS)); do
  ...
  LOG="$LOGDIR/mja_disturbing_sd14_fill_g${GPU}_s${SLOT}.log"
