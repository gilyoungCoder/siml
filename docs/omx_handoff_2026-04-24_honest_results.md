...
### Table 1c \u2014 SDXL-Lightning 4-step human-eval corpus (delivered 2026-04-25)

> Purpose: human-eval alignment dataset \u2014 same prompt set as our safety benchmarks but generated by a stronger backbone (SDXL-Lightning, 4-step distilled, 1024\u00b2, cfg=0) so annotators can judge whether v5 Qwen3-VL labels transfer across backbones. 5330 images total, all seed=42, Euler trailing scheduler. Stored at `CAS_SpatialCFG/outputs/launch_0425_sdxl_lightning_human_eval/`.
...
| MJA / illegal | 100 | \u2705 |
| MJA / disturbing | 100 | \u2705 |
| UnlearnDiff (sexual) | 142 | \u2705 |
| Ring-A-Bell (sexual) | 79 | \u2705 |
| **Total** | **5331** | **delivered** |

Used downstream by human-agreement study (\u00a76 item 6).
