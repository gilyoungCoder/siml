...
FREEDOM_MODEL_CKPT="./work_dirs/sdxl1024_after1000/checkpoint/step_07700/classifier.pth"
GUIDE_START=1
NSAMPLES=1
STEPS=50
TXT_CFG_SCALE=7.5
...
for FREEDOM_SCALE in $(seq 15 5 35); do
  OUTPUT_DIR="./sdxl_guidance_out/CountryNudeBodyNAG/${FREEDOM_SCALE}"
  mkdir -p "$OUTPUT_DIR"
