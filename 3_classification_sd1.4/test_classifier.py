...
from geo_utils.freedom_utils import load_model, measure_bald

# TMP
from geo_utils.freedom_utils import measure_prob_classifier
...
img_prefix = "/home/djfelrl11/geodiffusion/work_dirs/missing_person_512x512_240629/checkpoint/iter_2820/output_img/discriminator_guidance_off/"
...
for i, example in enumerate(dataloader):
  ...
  # save results
with open('predicted_disc_guidance_off.yaml', "w") as f:
