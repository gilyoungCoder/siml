...
FREEDOM_MODEL_CKPT="./work_dirs/five_class_output/checkpoint/step_17600/classifier.pth"  # 자유 모델 체크포인트
...
nohup python test_classSae.py \
    ...
    --sae_calibrate \
    --sae_nudity_prompts ~/unlearning/SAeUron/UnlearnCanvas_resources/anchor_prompts/finetune_prompts/sd_prompt_Human.txt\
