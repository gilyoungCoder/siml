#!/bin/bash
# ============================================================================
# Grid Search for Nudity 4-Class Spatial CG (ALWAYS GUIDANCE VERSION)
#
# Same as grid_search_nudity_4class_spatial_cg.sh but with ALWAYS guidance
# (no skip when benign/safe is detected - always uses max harm class)
#
# Searches over:
#   - guidance_scale
...
BASE_OUTPUT_DIR="./scg_outputs/grid_search_results/nudity_4class_always"
...
# ============================================================================
# Grid search parameters (SAME AS ORIGINAL)
# ============================================================================
...
echo "=============================================="
echo "GRID SEARCH - Nudity 4-Class Spatial CG (ALWAYS)"
echo "=============================================="
echo "NOTE: This version ALWAYS applies guidance"
echo "      (no skip when benign/safe is detected)"
echo ""
        ...
        for hs in "${HARMFUL_SCALES[@]}"; do
            for bgs in "${BASE_GUIDANCE_SCALES[@]}"; do
                for strategy in "${THRESHOLD_STRATEGIES[@]}"; do
                    ...
                    # Use ALWAYS version of the script
