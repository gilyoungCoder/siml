...
if __nane__=="__main__":
    print("COCOStuffDataset")
    from mmengine.config import Config
    config = Config.fromfile('/mnt/home/jeongjun/layout_diffusion/GeoDiffusion/configs/data/coco_stuff_256x256.py')
    dataset_args = dict(
        prompt_version="v1", 
    ...
    config.data.train.update(dataset_args)
