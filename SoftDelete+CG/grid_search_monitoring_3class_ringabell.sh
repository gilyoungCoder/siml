#!/bin/bash
# ============================================================================
# Multi-GPU Grid Search: 3-Class Sample-Level Monitoring + Spatial CG
# Ring-A-Bell prompts
# ============================================================================
#
# Usage:
#   ./grid_search_monitoring_3class_ringabell.sh                    # Run all
#   ./grid_search_monitoring_3class_ringabell.sh --dry-run          # Print only
#   ./grid_search_monitoring_3class_ringabell.sh --nohup            # Background
# ============================================================================
...
if [ "$USE_NOHUP" = true ]; then
    ...
    LOG_FILE="./scg_outputs/grid_search_mon3class_ringabell_${TIMESTAMP}.log"
    mkdir -p ./scg_outputs
...
GRADCAM_STATS_DIR="./gradcam_stats/nudity_3class"
SD_MODEL="CompVis/stable-diffusion-v1-4"
PROMPT_FILE="/mnt/home/yhgil99/unlearning/SAFREE/datasets/nudity-ring-a-bell.csv"

TIMESTAMP=$(date +%Y%m%d_%H%M%S)
BASE_OUTPUT_DIR="./scg_outputs/grid_search_mon3class_ringabell_${TIMESTAMP}"
...
echo "=============================================="
echo "MULTI-GPU GRID SEARCH: 3-Class Monitoring"
echo "=============================================="
...
run_on_gpu() {
    ...
    CUDA_VISIBLE_DEVICES=${actual_gpu} python generate_nudity_3class_sample_level_monitoring.py \
        --ckpt_path "${SD_MODEL}" \
        --prompt_file "${PROMPT_FILE}" \
