...
VIOLENCE_CLASSIFIER="./work_dirs/vangogh_three_class_diff/checkpoint/step_7200/classifier.pth"

# Prompt files
NUDITY_PROMPTS="./prompts/vangogh_50.txt"
VIOLENCE_PROMPTS="./prompts/vangogh_50.txt"
# MIXED_PROMPTS="./prompts/mixed_concepts.txt"  # If you have mixed prompts

# Output directory
OUTPUT_DIR="scg_outputs/multi_concept_vangogh/vangogh"
