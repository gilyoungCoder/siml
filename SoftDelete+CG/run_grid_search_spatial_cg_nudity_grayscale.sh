#!/bin/bash
# ============================================================================
# Grid Search - Spatial CG (Nudity Grayscale)
# Grayscale classifier용 grid search (clustering 없음)
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/grid_search_spatial_nudity_grayscale"
...
# grayscale stats: mean=0.568 (CDF 변환 후)
# threshold를 mean 근처로 설정
SPATIAL_THRESHOLDS=(
    # 높은 → 낮은 (초반 보수적, 후반 공격적)
    "0.6,0.4"
    "0.55,0.45"
...
BASE_GUIDANCE_SCALES=(1.0 2.0 3.0)
...
run_single_experiment() {
    ...
    # generate_always_adaptive_spatial_cg.py 사용 (clustering 없음)
...
main() {
    print_header "Grid Search - Spatial CG (Nudity Grayscale)"
    ...
    print_info "Grayscale Classifier 설정:"
