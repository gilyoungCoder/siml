...
OUTPUT_DIR="Continual/2classifier/"$F_SCALE                # 출력 디렉토리 경로
...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/SoftDelete+CG/work_dirs/nudity_two_class/checkpoint/step_100/classifier.pth"  # 2-class 모델 체크포인트
