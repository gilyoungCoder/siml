#!/bin/bash
# ============================================================================
# Adaptive Spatial CG - Nudity Grayscale (No Clustering)
# Grayscale classifier로 학습된 모델 사용, clustering 없이 spatial guidance만
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/spatial_cg_nudity_grayscale"
...
main() {
    print_header "Adaptive Spatial CG (Nudity Grayscale - No Clustering)"
    ...
    # 실행 명령어 (generate_always_adaptive_spatial_cg.py 사용 - clustering 없음)
