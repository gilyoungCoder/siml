...
# -*- coding: utf-8 -*-
"""
I2P 9-Class Adaptive Spatial Classifier Guidance

Supports all I2P concepts: harassment, hate, illegal, selfharm, shocking, violence

Dynamic Harm-Safe Pair Selection:
  - 9 classes: benign(0), harm0-safe0(1,2), harm1-safe1(3,4), harm2-safe2(5,6), harm3-safe3(7,8)
...
I2P_9CLASS_CONFIG = {
    ...
    "pairs": {
        "pair0": (1, 2),  # harm0, safe0
        "pair1": (3, 4),  # harm1, safe1
        "pair2": (5, 6),  # harm2, safe2
        "pair3": (7, 8),  # harm3, safe3
    },
...
def load_gradcam_stats_map(stats_dir: str) -> Dict[int, Dict[str, float]]:
    """
    Load 4 JSON files:
      - gradcam_stats_harm0_class1.json (class 1)
      - gradcam_stats_harm1_class3.json (class 3)
      - gradcam_stats_harm2_class5.json (class 5)
      - gradcam_stats_harm3_class7.json (class 7)
    Returns: {harm_class: {"mean": float, "std": float}}
    """
    stats_dir = Path(stats_dir)
    mapping = {
        1: "gradcam_stats_harm0_class1.json",
        3: "gradcam_stats_harm1_class3.json",
        5: "gradcam_stats_harm2_class5.json",
        7: "gradcam_stats_harm3_class7.json",
    }
    ...
    def __init__(
        ...
        if self.gradcam_stats_map is not None and len(self.gradcam_stats_map) > 0:
            ...
            for cls in sorted(self.gradcam_stats_map.keys()):
                ...
                name = I2P_9CLASS_CONFIG["class_names"][cls]
...
# =========================
def parse_args():
    parser = ArgumentParser(description="I2P 9-Class Adaptive Spatial CG")
    ...
    parser.add_argument("--output_dir", type=str, default="output_img/i2p_9class_spatial_cg",
                        help="Output directory")

    # Concept name
    parser.add_argument("--concept", type=str, required=True,
                        choices=["harassment", "hate", "illegal", "selfharm", "shocking", "violence"],
                        help="I2P concept name")
    ...
    parser.add_argument("--classifier_ckpt", type=str, required=True,
                        help="I2P 9-class classifier checkpoint path")
...
def visualize_dynamic_guidance(
    ...
    labels = {1: 'harm0', 3: 'harm1', 5: 'harm2', 7: 'harm3'}
    for hc in [1, 3, 5, 7]:
    ...
    ax3.set_yticklabels(['harm0(1)', 'harm1(3)', 'harm2(5)', 'harm3(7)'])
    ...
    for hc, c in sorted(cnt.items()):
        name = I2P_9CLASS_CONFIG['class_names'][hc]
...
def generate_with_dynamic_guidance(
    ...
    print("\n" + "="*80)
    print(f"I2P 9-CLASS DYNAMIC SPATIAL CLASSIFIER GUIDANCE - {args.concept.upper()}")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print(f"I2P 9-CLASS DYNAMIC SPATIAL CG - {args.concept.upper()}")
    print("="*80)
    ...
    # Load classifier
    print(f"\n[4/6] Loading {args.concept} 9-class classifier from {args.classifier_ckpt}...")
    ...
    print(f"  Harm classes: {I2P_9CLASS_CONFIG['harm_classes']}")
    print(f"  Safe classes: {I2P_9CLASS_CONFIG['safe_classes']}")
    print(f"  Skip if safe: {args.skip_if_safe}")
