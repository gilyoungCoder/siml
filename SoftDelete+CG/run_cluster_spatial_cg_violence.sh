#!/bin/bash
# ============================================================================
# Cluster-Aware Adaptive Spatial CG - Violence Version
# Clustering + Spatial Guidance 결합 추론 (Violence)
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/cluster_spatial_cg_violence"
...
main() {
    print_header "Cluster-Aware Spatial CG (Violence)"
