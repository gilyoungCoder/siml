#!/bin/bash
# ============================================================================
# Grid Search: Nudity 6-Class v2 Spatial CG (SKIP IF SAFE VERSION)
#
# v2 Classes:
#   0: benign (no people)
...
#
# This version SKIPS guidance if max logit is benign(0) or safe_clothed(1)
# (Same behavior as 4class original version)
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/grid_search_nudity_6class_v2_step${STEP}_skip"
...
echo "=============================================="
echo "Grid Search: Nudity 6-Class v2 Spatial CG (SKIP IF SAFE)"
echo "=============================================="
echo "NOTE: This version SKIPS guidance when benign/safe is max"
echo ""
