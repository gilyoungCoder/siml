#!/bin/bash
# ============================================================================
# Grid Search - Always-On Adaptive Spatial CG
# guidance_scale, spatial_threshold, harmful_scale, base_guidance_scale 탐색
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/grid_search_jtt_step18400"
...
main() {
    print_header "Grid Search - Adaptive Spatial CG"
    ...
    print_config "SPATIAL_THRESHOLDS" "${SPATIAL_THRESHOLDS[*]}"
