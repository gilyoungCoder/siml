#!/bin/bash
# ============================================================================
# Grid Search - Cluster-Aware Spatial CG (Violence)
...
OUTPUT_BASE_DIR="./scg_outputs/grid_search_cluster_spatial_violence"
...
run_single_experiment() {
    ...
    python generate_cluster_spatial_cg.py \
        $CKPT_PATH \
...
main() {
    print_header "Grid Search - Cluster Spatial CG (Violence)"
