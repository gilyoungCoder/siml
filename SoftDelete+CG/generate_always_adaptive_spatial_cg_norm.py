    ...
    def compute_gradient(
        ...
        with torch.enable_grad():
            ...
            if self.use_bidirectional:
                ...
                logits_safe = self.classifier(latent_for_safe, timestep.float() /1000.0)
                ...
                logits_harmful = self.classifier(latent_for_harmful, timestep.float() /1000.0)
                ...
                logits = self.classifier(latent_input, timestep.float() /1000.0)
