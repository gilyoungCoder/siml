...
# =========================
# Machine Unlearning with ADAPTIVE THRESHOLD
...
OUTPUT_DIR="./SDCGlegacy/i2psexual_CG_previous_15"
...
# CLASSIFIER_CKPT="./work_dirs/nudity_three_class_clothed/checkpoint/step_10700/classifier.pth"
GUIDANCE_SCALE=15
...
# =========================
mkdir -p "${OUTPUT_DIR}"
LOG="./logs/run_adaptive_$(date +%Y%m%d_%H%M%S).log"
mkdir -p "$(dirname "${LOG}")"

echo ""
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                MACHINE UNLEARNING - ADAPTIVE THRESHOLD MODE                    ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "[INFO] Starting generation with ADAPTIVE THRESHOLD mode..."
