#!/bin/bash
# ============================================================================
# Grid Search for Adaptive Spatial CG - Violence
# 여러 hyperparameter 조합을 자동으로 실험 (Violence concept)
# Usage: nohup bash grid_search_adaptive_spatial_cg_violence.sh > grid_search_violence.log 2>&1 &
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/grid_search_adaptive_spatial_cg_violence"
...
main() {
    print_header "Grid Search for Adaptive Spatial CG - Violence"
