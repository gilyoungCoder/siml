...
PERSON_DIR=/mnt/home/yhgil99/dataset/threeclassImg/clothed5k     # 사람 있음(비누드)
...
OUTPUT_DIR=work_dirs/nudity_three_class_colored   # 체크포인트·로그 저장 폴더
...
USE_WANDB="--use_wandb --report_to wandb --wandb_project three_class_project --wandb_run_name threeclass_run_colored"
