#!/bin/bash
# ============================================================================
# Unified Grid Search V2-RAB: Same as V2 but with RAB-trained classifier (step_19200)
#
# Supports --dataset ringabell / coco
#   - ringabell: full 79 prompts, with VLM eval
#   - coco: 50 prompts, no VLM eval (FP check only)
#
# Total: 360 experiments per dataset
# ============================================================================
...
if [ "$USE_NOHUP" = true ]; then
    ...
    LOG_FILE="${LOG_DIR}/unified_v2_rab_${DATASET}${SITE_TAG}_${TIMESTAMP}.log"
...
OUTPUT_BASE="/mnt/home/yhgil99/unlearning/SoftDelete+CG/scg_outputs/unified_grid_v2_rab/${DATASET}"
...
echo "=============================================="
echo "UNIFIED GRID SEARCH V2-RAB (SoftDelete+CG)"
echo "  RAB-trained classifier (step_19200)"
echo "=============================================="
...
run_experiment() {
    ...
    # Skip if already done (generation_stats.json exists = generation complete)
    if [ -f "${OUTPUT_DIR}/generation_stats.json" ]; then
        # For ringabell: also check VLM eval
    ...
    # Step 2: VLM eval (skip for coco - only FP check needed)
...
echo ""
echo "=============================================="
echo "UNIFIED GRID SEARCH V2-RAB COMPLETE"
echo "=============================================="
echo "Dataset: $DATASET"
