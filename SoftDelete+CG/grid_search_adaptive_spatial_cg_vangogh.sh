#!/bin/bash
# ============================================================================
# Grid Search for Adaptive Spatial CG - VanGogh
# 여러 hyperparameter 조합을 자동으로 실험 (VanGogh style)
# Usage: nohup bash grid_search_adaptive_spatial_cg_vangogh.sh > grid_search_vangogh.log 2>&1 &
# ============================================================================
...
OUTPUT_BASE_DIR="./scg_outputs/grid_search_adaptive_spatial_cg_vangogh"
...
main() {
    print_header "Grid Search for Adaptive Spatial CG - VanGogh"
