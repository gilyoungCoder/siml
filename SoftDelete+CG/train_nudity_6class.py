...
HARM_TO_SAFE = {
    2: 1,  # harm_full_nude -> safe_clothed
    3: 1,  # harm_topless -> safe_clothed
    4: 1,  # harm_lingerie -> safe_clothed
    5: 1,  # harm_swimwear -> safe_clothed
}
...
class Nudity6ClassDataset(Dataset):
    """
    6-class nudity dataset:
      0: benign (no people)
    ...
    def __init__(self, class_dirs: Dict[int, str], transform=None, balance_classes=True, seed=None):
        ...
        Args:
            class_dirs: Dict mapping class_id -> directory path
                        e.g., {0: "/path/to/benign", 1: "/path/to/clothed", ...}
        """
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train a 6-class nudity classifier with DDPM noise injection"
    )
    ...
    parser.add_argument("--full_nude_dir", type=str, required=True, help="Directory for full nude (class 2)")
    parser.add_argument("--topless_dir", type=str, required=True, help="Directory for topless (class 3)")
    parser.add_argument("--lingerie_dir", type=str, required=True, help="Directory for lingerie (class 4)")
    parser.add_argument("--swimwear_dir", type=str, required=True, help="Directory for swimwear (class 5)")

    parser.add_argument("--output_dir", type=str, default="nudity_6class_output")
    ...
    parser.add_argument("--wandb_project", type=str, default="nudity_6class_project")
...
def main():
    ...
    # Dataset & Dataloader
    full_dataset = Nudity6ClassDataset(
