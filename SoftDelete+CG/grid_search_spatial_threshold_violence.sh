#!/bin/bash
# ============================================================================
# Grid Search for Spatial Threshold - Violence (Gaussian CDF Normalized)
...
CLASSIFIER_PATH="./work_dirs/violence_three_class_diff/checkpoint/step_9500/classifier.pth"
OUTPUT_BASE_DIR="./scg_outputs/grid_search_threshold_violence"
...
THRESHOLD_STARTS=(0.3 0.4 0.5 0.6 0.7)
THRESHOLD_ENDS=(0.5 0.6 0.7 0.8 0.9)
...
if [ ! -f "$GRADCAM_STATS_FILE" ]; then
    ...
    echo -e "  ${CYAN}./compute_gradcam_stats_violence.sh${NC}"
    exit 1
fi
...
print_header "Grid Search: Violence Spatial Threshold (Gaussian CDF Normalized)"
...
print_header "Grid Search 완료 - Violence"
