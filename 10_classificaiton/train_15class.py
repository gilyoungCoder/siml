...
def parse_args():
    ...
    parser.add_argument("--output_dir",                  type=str, default="fifteen_class_output")
    ...
    parser.add_argument("--wandb_project",               type=str, default="fifteen_class_project")
...
def main():
    ...
    # Dataset & Dataloader
    full_dataset = FifteenClassDataset(
