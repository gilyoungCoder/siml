...
OUTPUT_DIR="Continual/CountryBodyStepIndex/"+$F_SCALE                # 출력 디렉토리 경로
...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/10_classificaiton/work_dirs/eleven_class_output/checkpoint/step_9100/classifier.pth"  # 자유 모델 체크포인트
