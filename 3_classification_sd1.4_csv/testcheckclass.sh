...
OUTPUT_DIR="Continual/CountryNudeBody/no_guidance_cls"               # 출력 디렉토리 경로
...
# 실행할 명령어
nohup python testcheckclass.py \
    --ckpt_path $CKPT_PATH \
    ...
    --cls_dump_csv "$OUTPUT_DIR/cls_dump.csv" \
    --cls_dump_max_step 50 \
    --cls_dump_after_guidance \
    --sae_calibrate \
