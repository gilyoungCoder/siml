...
class StableDiffusion3Pipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        negation_warmup_end = kwargs.get("negation_warmup_end", 780)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if (t <= negation_warmup_start) and (t >= negation_warmup_end) and repellency_processor is not None: # Warmup
                    # TO DEBUG
