...
class ModifiedSafreeDiffusionPipeline_Rep(StableDiffusionPipeline):
    def __init__(self,
        vae,
        text_encoder,
        tokenizer,
        ...
        super(ModifiedSafreeDiffusionPipeline_Rep, self).__init__(
                vae,
                text_encoder,
                tokenizer,
                unet,
    ...
    def __call__(
        ...
        **kwargs
        ...
        # TO DEBUG
        initial_timestep_without_negation = -1.
                ...
                if (t <= negation_warmup_start) and (t >= negation_warmup_end): # Warmup
                    if repellency_processor is not None:
                        ...
                        if repellency_dict.get("is_negation", False):
                            # TO DEBUG
                            # print("-"*10, f"Repellency applied at # of step {i}", "-"*10)
