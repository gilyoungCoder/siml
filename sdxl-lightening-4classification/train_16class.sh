...
OUTPUT_DIR=work_dirs/sixteen_class_output_after4600
...
nohup python train_16class.py \
  ...
  $USE_WANDB \
  > train_16class.log 2>&1 &

echo "Training launched. Logs are in train_16class.log"
