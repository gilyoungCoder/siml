...
# accelerate launch --multi_gpu --mixed_precision fp16 --gpu_ids 0,1,2,3 --num_processes 4 \
# train_geodiffusion.py \
#     --pretrained_model_name_or_path KaiChen1998/geodiffusion-coco-stuff-256x256 \
...
# 	--output_dir work_dirs/missing_person_256x256_v1 \
#     --report_to wandb