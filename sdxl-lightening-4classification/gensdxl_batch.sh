...
FREEDOM_MODEL_CKPT="./work_dirs/cheatingRound/r2/checkpoint/step_00700/classifier.pth"
GUIDE_START=1
NSAMPLES=1
STEPS=50
TXT_CFG_SCALE=7.5
...
for FREEDOM_SCALE in $(seq 5 5 25); do
  OUTPUT_DIR="./sdxl_guidance_out/CountryNudeBody/Cheating/Round2/${FREEDOM_SCALE}"
  mkdir -p "$OUTPUT_DIR"
