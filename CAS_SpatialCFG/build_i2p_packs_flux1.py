#!/usr/bin/env python3
"""Build I2P family exemplar packs using FLUX.1-dev as the exemplar generator."""
...
DST_ROOT = Path('/mnt/home3/yhgil99/unlearning/CAS_SpatialCFG/exemplars/i2p_v1_flux1')
...
def main():
    ...
    print(f'[FLUX1 pack build] cats={cats} steps={args.steps} gs={args.gs} res={args.res}')
    print('[load] FLUX.1-dev...')
    ...
    for cat in cats:
        ...
        for fname, fdata in families.items():
            ...
            for i, p in enumerate(tgt_prompts):
                ...
                img = pipe(p, num_inference_steps=args.steps, guidance_scale=args.gs,
                           generator=gen, height=args.res, width=args.res,
