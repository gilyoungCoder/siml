...
GPU=6
LOGDIR=/mnt/home3/yhgil99/unlearning/CAS_SpatialCFG/launch_0426_full_sweep/paper_results/reproduce/sd14_q16_repro_ours_baselines_20260430/logs/phase_safree_multi_q16top60_v5_0501_direct
mkdir -p "$LOGDIR"
run_eval(){
...
echo "[$(date)] ALL_DONE phase_safree_multi_q16top60 v5 direct"
