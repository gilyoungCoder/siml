#!/bin/bash
# ============================================================================
# v17 Grid Search + Evaluation (IP-Adapter Image Projection)
# WHEN: CAS (tau=0.6) | WHERE: IP-Adapter projected probe | HOW: dag_adaptive/hybrid
...
TOTAL=${#CONFIGS[@]}
echo "========================================="
echo " v17 Grid Search: $TOTAL configs"
echo " GPUs: ${GPU_IDS[*]}"
echo "========================================="
...
run_one() {
  ...
  CUDA_VISIBLE_DEVICES=$gpu_id $PYTHON generate_v17.py \
    --prompts "$PROMPTS" \
    --outdir "$out_dir" \
    --guide_mode "$gm" \
    --safety_scale "$ss" \
...
echo ""
echo "========================================="
echo " v17 Grid Search COMPLETE: $TOTAL configs"
echo "========================================="
