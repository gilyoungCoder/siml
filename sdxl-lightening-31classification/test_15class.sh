...
OUTPUT_DIR="Continual/CountryBody/"+$F_SCALE                # 출력 디렉토리 경로
...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/15_classificaiton/work_dirs/fifteen_class_output/checkpoint/step_41600/classifier.pth"  # 자유 모델 체크포인트
...
CONFIG_PATH="/mnt/home/yhgil99/unlearning/15_classificaiton/configs/models/time_dependent_discriminator.yaml"
