#!/bin/bash
output_dir=missing_person_512_512_240909_discriminator
...
pretrained_model="/home/djfelrl11/geodiffusion/work_dirs/missing_person_512_512_240904_clf/checkpoint/iter_1620"

# command_line="bash "

# if [[ $PJRT_DEVICE == "TPU" ]]; then
# 	echo "The device is set as TPU: get into the TPU mode."
# 	command_line+="tools/tpu/dist_train.sh "
