...
# output_dir=250224_disc_vaal_mscoco_balanced_time_dependent_cycle_${cycle}_epoch_100_seen_0.04_coreset_selected_faster_rcnn
output_dir=250225_disc_vaal_mscoco_balanced_time_dependent_cycle_${cycle}_epoch_100_seen_0.04_coreset_selected_scale_5.0_retinanet
...
time_dependent=true
adversarial_scale=1
seen_dataset_ratio=0.04  # 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4
...
manual_unseen_file_name="/home/djfelrl11/for_cycle_${cycle}_selected_unseen_retinanet.txt"
...
# basg inference_start.sh
CALLED=true OUTPUT_DIR=output_img/$output_dir FREEDOM_MODEL_ARGS_FILE=$model_yaml FREEDOM_MODEL_CKPT=/home/djfelrl11/geodiffusion/work_dirs/$output_dir CYCLE=$cycle \
	bash inference_start.sh 
