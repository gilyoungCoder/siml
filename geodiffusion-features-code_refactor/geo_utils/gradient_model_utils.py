...
class GradientModel(metaclass=ABCMeta):
    ...
    def get_grad(self, image, timestep, encoder_hidden_states=None, grad_input=None):
        # differentiate_value = self.get_differentiate_value(image, timestep, encoder_hidden_states)
        differentiate_value, output_for_log = self.get_differentiate_value(image, timestep, encoder_hidden_states)
        grad_val = None
