...
def create_discriminator(ckpt_path, condition, eval=False, channel=4, num_classes=2):
...
def load_discriminator(ckpt_path, condition, eval=False, channel=4, num_classes=2):
    discriminator = create_discriminator(ckpt_path, condition, eval, channel, num_classes=num_classes)
