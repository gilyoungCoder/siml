...
Extensive experiments on seven I2P safety categories demonstrate that \ours{} achieves state-of-the-art safety rates (94.9\% on Ring-A-Bell, 97.2\% on UnlearnDiff) while preserving image quality (FID 4.72 on COCO), outperforming both fine-tuning methods (ESD, SDD, RECE) and training-free baselines (SLD, SAFREE).
