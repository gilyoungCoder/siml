...
% max_f funnel — WIDER (0.9cm) and pushed RIGHT so no overlap with probe boxes
\pgfmathsetmacro{\funL}{\Cx + 1.55}   % left edge of funnel trapezoid
\pgfmathsetmacro{\funR}{\Cx + 2.45}   % right edge
