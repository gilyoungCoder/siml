...
# -*- coding: utf-8 -*-
"""
Train a z0-space classifier for SD1.4 latent classifier guidance.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train z0-space classifier for SD1.4 guidance"
    )
    parser.add_argument(
    ...
    # Training
    parser.add_argument("--output_dir", type=str, default="work_dirs/z0_classifier")
