...
nohup python train_i2p_9class.py \
    ...
    --output_dir "./work_dirs/z0_harassment_9class" \
    --train_batch_size 16 \
    ...
    --wandb_run_name "z0_harassment_9class" \
    > logs/train_harassment.log 2>&1 &

echo "[GPU 2] harassment 9-class started. PID=$!"
