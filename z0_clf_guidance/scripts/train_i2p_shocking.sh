...
nohup python train_i2p_9class.py \
    ...
    --output_dir "./work_dirs/z0_shocking_9class" \
    --train_batch_size 16 \
    ...
    --wandb_run_name "z0_shocking_9class" \
    > logs/train_shocking.log 2>&1 &

echo "[GPU 6] shocking 9-class started. PID=$!"
