...
FREEDOM_MODEL_CKPT="./work_dirs/11cls1024NL_modified/checkpoint/step_01600/classifier.pth"
GUIDE_START=1
NSAMPLES=1
STEPS=50
TXT_CFG_SCALE=7.5
...
for FREEDOM_SCALE in $(seq 5 5 15); do
  OUTPUT_DIR="./sdxl_guidance_out/CountryNudeBodyNL/${FREEDOM_SCALE}"
  mkdir -p "$OUTPUT_DIR"
