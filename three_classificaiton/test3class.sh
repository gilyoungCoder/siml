...
OUTPUT_DIR="Continual/timedependent3/discriminator"+$F_SCALE                # 출력 디렉토리 경로
...
FREEDOM_MODEL_CKPT="/mnt/home/yhgil99/unlearning/three_classificaiton/work_dirs/nudity_three_class/checkpoint/step_13600/classifier.pth"  # 자유 모델 체크포인트
