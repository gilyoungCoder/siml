...
PROMPT_FILE="/mnt/home/yhgil99/guided2-safe-diffusion/prompts/country_naked_body2.txt"
FREEDOM_MODEL_ARGS="./configs/models/time_dependent_discriminator.yaml"
FREEDOM_MODEL_CKPT="./work_dirs/sdxl1024_hier/classifier_final.pth"
GUIDE_START=1
NSAMPLES=1
STEPS=50
TXT_CFG_SCALE=7.5
...
for FREEDOM_SCALE in $(seq 5 10 30 ); do
  OUTPUT_DIR="./sdxl_guidance_out/CountryNudeBodyHier/${FREEDOM_SCALE}"
  mkdir -p "$OUTPUT_DIR"
